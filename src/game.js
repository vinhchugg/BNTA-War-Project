...
Game.prototype.playWar = function () {
  if (player0.hand.length < 4) {
    this.isPlaying = false;
    return "Player 2 has less than 4 cards, Player 1 has won the game!";
  }
  if (player1.hand.length < 4) {
    this.isPlaying = false;
    return "Player 1 has less than 4 cards, Player 2 has won the game!";
  }
